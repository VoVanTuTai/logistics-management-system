  ...
  const users = [
    {
      ...
      phone: '0900001001',
      hubCodes: ['001A001', '003A001'],
    },
    {
      username: '20000001',
      plainPassword: 'password',
      roles: ['OPS_ADMIN'],
      displayName: 'Ops Hub Hà Nội',
      phone: '0900002001',
      hubCodes: ['001A001'],
    },
    {
      ...
      plainPassword: 'password',
      roles: ['OPS_ADMIN'],
      displayName: 'Ops Hub Hồ Chí Minh',
      phone: '0900002002',
      hubCodes: ['003A001'],
    },
    {
      ...
      plainPassword: 'password',
      roles: ['MERCHANT'],
      displayName: 'Shop Minh Anh Hà Nội',
      phone: '0900003001',
      hubCodes: ['001A001'],
    },
    {
      ...
      plainPassword: 'password',
      roles: ['MERCHANT'],
      displayName: 'Thời trang Bảo Ngọc Hà Nội',
      phone: '0900003002',
      hubCodes: ['001A001'],
    },
    {
      ...
      plainPassword: 'password',
      roles: ['MERCHANT'],
      displayName: 'Shop Sài Gòn Fresh',
      phone: '0900003003',
      hubCodes: ['003A001'],
    },
    {
      ...
      plainPassword: 'password',
      roles: ['MERCHANT'],
      displayName: 'Mỹ phẩm An Nhiên HCM',
      phone: '0900003004',
      hubCodes: ['003A001'],
    },
    {
