...
const VALID_TRANSITIONS: Record<ShipmentCurrentStatus, ReadonlySet<ShipmentCurrentStatus>> = {
  ...
  TASK_ASSIGNED: new Set([
    ...
    'RETURN_STARTED', 'RETURN_COMPLETED', 'CANCELLED',
  ]),
  PICKUP_COMPLETED: new Set([
    'PICKUP_COMPLETED', 'TASK_ASSIGNED', 'SCAN_OUTBOUND', 'SEND_GOODS',
    'MANIFEST_SEALED', 'SCAN_INBOUND', 'IN_TRANSIT', 'EXCEPTION', 'RETURN_STARTED',
    'CANCELLED',
  ]),
  MANIFEST_SEALED: new Set([
    ...
    'EXCEPTION', 'RETURN_STARTED', 'CANCELLED',
  ]),
  MANIFEST_RECEIVED: new Set([
    ...
    'IN_TRANSIT', 'EXCEPTION', 'RETURN_STARTED', 'CANCELLED',
  ]),
  ...
  SEND_GOODS: new Set([
    ...
    'SCAN_INBOUND', 'EXCEPTION', 'RETURN_STARTED', 'CANCELLED',
  ]),
  IN_TRANSIT: new Set([
    'IN_TRANSIT', 'SCAN_INBOUND', 'MANIFEST_RECEIVED', 'MANIFEST_UNSEALED',
    'INVENTORY_CHECK', 'SCAN_OUTBOUND', 'SEND_GOODS', 'EXCEPTION', 'RETURN_STARTED',
    'CANCELLED',
  ]),
  INVENTORY_CHECK: new Set([
    'INVENTORY_CHECK', 'SCAN_INBOUND', 'TASK_ASSIGNED', 'SCAN_OUTBOUND',
    'SEND_GOODS', 'IN_TRANSIT', 'EXCEPTION', 'NDR_CREATED', 'RETURN_STARTED', 'RETURN_COMPLETED', 'CANCELLED',
  ]),
  SCAN_INBOUND: new Set([
    'SCAN_INBOUND', 'INVENTORY_CHECK', 'TASK_ASSIGNED', 'SCAN_OUTBOUND',
    'SEND_GOODS', 'IN_TRANSIT', 'MANIFEST_SEALED', 'EXCEPTION', 'NDR_CREATED', 'RETURN_STARTED', 'RETURN_COMPLETED',
    'CANCELLED',
  ]),
  SCAN_OUTBOUND: new Set([
    'SCAN_OUTBOUND', 'SEND_GOODS', 'IN_TRANSIT', 'MANIFEST_SEALED',
    'SCAN_INBOUND', 'TASK_ASSIGNED', 'EXCEPTION', 'RETURN_STARTED', 'CANCELLED',
  ]),
  DELIVERED: new Set([
    'DELIVERED',
    // Terminal forward status: hàng đã ký nhận.
  ]),
  DELIVERY_FAILED: new Set([
    'DELIVERY_FAILED', 'DELIVERED', 'NDR_CREATED', 'EXCEPTION',
    'INVENTORY_CHECK', 'TASK_ASSIGNED', 'RETURN_STARTED', 'CANCELLED',
  ]),
  NDR_CREATED: new Set([
    'NDR_CREATED', 'DELIVERED', 'EXCEPTION', 'INVENTORY_CHECK', 'TASK_ASSIGNED',
    'RETURN_STARTED', 'CANCELLED',
  ]),
  EXCEPTION: new Set([
    'EXCEPTION', 'NDR_CREATED', 'INVENTORY_CHECK', 'TASK_ASSIGNED',
    'SCAN_INBOUND', 'SCAN_OUTBOUND', 'RETURN_STARTED', 'RETURN_COMPLETED', 'CANCELLED',
  ]),
  RETURN_STARTED: new Set([
    'RETURN_STARTED', 'RETURN_COMPLETED', 'TASK_ASSIGNED',
    'SCAN_INBOUND', 'SCAN_OUTBOUND', 'IN_TRANSIT',
    'MANIFEST_SEALED', 'MANIFEST_RECEIVED', 'MANIFEST_UNSEALED',
    'INVENTORY_CHECK', 'CANCELLED',
  ]),
