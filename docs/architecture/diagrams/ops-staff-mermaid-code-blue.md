...
> File này dùng để mở bằng VS Code + extension **Markdown Preview Mermaid Support**. Phiên bản này dùng tông **xanh dương** để dễ nhìn khi chụp hình đưa vào báo cáo/slide.  
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'background': '#ffffff', 'mainBkg': '#ffffff', 'primaryColor': '#EAF3FF', 'primaryBorderColor': '#2563EB', 'primaryTextColor': '#0F172A', 'lineColor': '#1E40AF', 'actorBkg': '#DBEAFE', 'actorBorder': '#2563EB', 'actorTextColor': '#0F172A', 'signalColor': '#1D4ED8', 'signalTextColor': '#0F172A', 'noteBkgColor': '#EFF6FF', 'noteTextColor': '#1E3A8A' }}}%%
sequenceDiagram
    autonumber
