...
export const SAMPLE_WARD_HUBS: WardHubSeed[] = [
  ...
  {
    code: '04801W002',
    name: 'Bưu cục Phường Thanh Bình - Hải Châu',
    parentHubCode: '002048B001',
    provinceCode: 48,
    provinceName: 'Thành phố Đà Nẵng',
    district: 'Quận Hải Châu',
    ward: 'Phường Thanh Bình',
    addressLine: '45 Ông Ích Khiêm, Phường Thanh Bình, Quận Hải Châu',
    phone: '0236381102',
    contactName: 'Trưởng Bưu cục Thanh Bình',
    latitude: 16.0635,
    longitude: 108.2105,
    boundaryPolygon: [
      [16.057, 108.203],
  ...
  },
  {
    ...
    addressLine: '88 Ngô Quyền, Phường An Hải Bắc, Quận Sơn Trà',
    phone: '0236381103',
    contactName: 'Trưởng Bưu cục An Hải Bắc',
    latitude: 16.0780,
    longitude: 108.2365,
    boundaryPolygon: [
      [16.072, 108.230],
...
const FALLBACK_PROVINCES: VietnamProvinceSeed[] = [
  ['Thành phố Hà Nội', 1, 'ha_noi', 'Phường Hàng Bài'],
  ...
  ['Thành phố Đà Nẵng', 48, 'da_nang', 'Phường Thạch Thang'],
  ...
  ['Thành phố Hồ Chí Minh', 79, 'ho_chi_minh', 'Phường Bến Thành'],
